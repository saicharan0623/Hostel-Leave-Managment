...
try {
    ...
    $query = 'SELECT * FROM leave_applications where status="APPROVED" order by name asc';
    //$query = 'SELECT * FROM leave_applications where status!="REJECTED" order by name,status asc';
    $query = 'SELECT * FROM leave_applications WHERE status="APPROVED"';
