...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        $updateQuery = "UPDATE leave_applications SET status = 'REJECTED' WHERE id = :id AND created_at = :created_at";
        ...
        $stmt->execute();
         ...
         try {
            ...
            /*  $mail->setFrom('venkatdada369@gmail.com', 'Sender Name');
             $mail->addAddress('venkatdada369@gmail.com', 'Recipient Name'); */
             ...
             <body>
                 <div class="container">
                     ...
                     <p>This email is to inform you that your leave application has been <strong>Rejected</strong>.</p>
                     <h3><strong>Reason for Rejection:</strong> ' . $reject_reason . '</h3>
