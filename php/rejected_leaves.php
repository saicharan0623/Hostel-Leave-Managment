...
try {
    // Get only rejected leaves with student information
    $query = 'SELECT 
                l.id,
                l.student_id,
                l.from_date,
...
<head>
    ...
    <title>Admin Panel - Rejected Leave Applications</title>
...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <h1 class="text-center text-danger">Rejected Leave Applications</h1>
