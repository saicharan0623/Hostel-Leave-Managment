...
<head>
    ...
    <title>Leave Confirmation Message</title>
    <style>
        /* CSS styles here */
        body {
            ...
            position: relative;
            /* Required for absolute positioning of footer */
        }
        ...
        .container {
            ...
            position: relative;
            /* Ensure container does not overlap the footer */
            z-index: 1;
            /* Ensure container is above the footer */
        }
...
<body>
    <div class="container">
        ...
        <p>Your confirmation was successful.</p>
        <p>Thank you!</p>
